import { AlertTriangleIcon, Loader2Icon, MoreVerticalIcon, PlusIcon, SearchIcon, Trash2Icon } from "lucide-react";
...
export const EntitySearch = ({ placeholder = "Search", value, onChange }: EntitySearchProps) => {
    return (
        <div className="relative ml-auto">
            ...
            <Input
                className="w-[200px] bg-background shadow-none border-border pl-8"
    ...
    return (
        <div className="flex flex-row items-center justify-between gap-x-2 w-full">
            ...
            <div className="flex items-center justify-end space-x-2 py-4">
                ...
                <Button disabled={page === totalPages || totalPages === 0 || disabled} variant="outline" size="sm" onClick={() => onPageChange(Math.min(totalPages, page + 1))}>Next</Button>
            </div>
        </div>
    );
}
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            {onRemove && (
                                <DropdownMenu>
                                    ...
                                    {/* When you click on the menu it will close the dropdown and does not count as link click */}
